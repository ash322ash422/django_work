...
SECRET_KEY = 'django-insecure-iddvhd#g6yg)ybedxiwrxbjo2%+a*j&aome2wwgh-m&twakn&$'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'Discussion.context_processors.recaptcha',
...
DEFAULT_FROM_EMAIL = 'Django Categories <noreply@djangocategories.com>'
EMAIL_SUBJECT_PREFIX = '[Django Categories] '
