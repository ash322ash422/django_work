...
response = requests.post("http://127.0.0.1:8000/api/purchase_orders/", 
    data={'po_number': po_number_for_test[0], 
          ...
          'order_date':          '2024-01-01T01:01:00.00',
          'issue_date':          '', 
          'acknowledgment_date':  '',
          'delivery_date':        '',
          'quantity': 1,
...
response = requests.patch("http://127.0.0.1:8000/api/purchase_orders/{}/acknowledge/".format(po_id1),
    data={'po_number': po_number_for_test[0], 
          ...
          'issue_date':          '2024-01-03T01:10:00',
          'acknowledgment_date': '2024-01-01T01:11:00',
...
print("Updating purchase order :{}".format(po_id1))
print("Sending PUT /api/purchase_orders/{}/".format(po_id1))
response = requests.put("http://127.0.0.1:8000/api/purchase_orders/{}/".format(po_id1), 
    data={'po_number': po_number_for_test[0], 
          'vendor': vendor_id1, # NOTE: This needs to valid vendor
...
print("Updating purchase order :{}".format(po_id2))
